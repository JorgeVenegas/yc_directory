    ...
    const handleFromSubmit = async (prevState: any, formData: FormData) => {
        try {
            ...
            if (error instanceof z.ZodError) {
                ...
                toast({ title: "Error", description: "Something went wrong. Check your inputs and try again", variant: "destructive" })
                return { ...prevState, error: "Validaiton faiiled", status: "ERROR" }
            }
            toast({ title: "Error", description: "Something went wrong. An unexpected error happened", variant: "destructive" })
    ...
    return (
        <form action={formAction} className='startup-form'>
            ...
            <div data-color-mode="light">
                ...
                <MDEditor
                    value={pitch}
                    onChange={(newValue) => setPitch(newValue as string)}
                    id='pitch'
                    preview='edit'
                    height={300}
                    style={{ borderRadius: 20, overflow: 'hidden' }}
                    textareaProps={{
                        placeholder: "Briefly describe your idea and why is it special."
                    }}
                    previewOptions={{
